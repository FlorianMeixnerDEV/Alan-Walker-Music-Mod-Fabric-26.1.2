...
public class BodyguardEntity extends PathfinderMob {
	...
	public void playStepSound(BlockPos pos, BlockState blockIn) {
		this.playSound(BuiltInRegistries.SOUND_EVENT.getValue(Identifier.parse("alan_walker_music_fabric:schritte")), 0.15f, 1);
	}
	...
	public static void init() {
		BiomeModifications.addSpawn(GENERATE_BIOMES, MobCategory.MONSTER, AlanWalkerMusicFabricModEntities.BODYGUARD, 20, 4, 4);
	}
