...
public abstract class EquipmentLayerRendererMixin {
	...
	public <S> void renderLayers(EquipmentClientInfo.LayerType layerType, ResourceKey<EquipmentAsset> resourceKey, Model<? super S> model, S state, ItemStack itemStack, PoseStack poseStack, SubmitNodeCollector submitNodeCollector, int lightCoords,
		...
		if (!AlanWalkerMusicFabricModArmorModels.ARMOR_MODELS.containsKey(itemStack.getItem()) || layerType == EquipmentClientInfo.LayerType.WINGS)
			return;
		AlanWalkerMusicFabricModArmorModels.ArmorModel armorModel = AlanWalkerMusicFabricModArmorModels.ARMOR_MODELS.get(itemStack.getItem());
