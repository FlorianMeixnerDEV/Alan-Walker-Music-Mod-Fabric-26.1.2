...
import net.florianmeixnerdev.alanwalkermusic.client.gui.WalkerRadioGUIScreen;
...
public class AlanWalkerMusicFabricModScreens {
	public static void clientLoad() {
		MenuScreens.register(AlanWalkerMusicFabricModMenus.LINK_INFO, LinkInfoScreen::new);
		MenuScreens.register(AlanWalkerMusicFabricModMenus.WALKER_RADIO_GUI, WalkerRadioGUIScreen::new);
	}
